...
def fetch_unique(idx, query, already_recommended):
    page_size = 10
...
if __name__ == '__main__':
    ...
    while True:
        print("Here's a recommendation for you, based on the companies you have already indicated preferring: ")
        (result_company_name, result_company_desc) = fetch_unique(idx, query, already_recommended)
